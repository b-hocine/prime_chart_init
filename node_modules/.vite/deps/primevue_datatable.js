      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread$1(_objectSpread$1({}, group), {}, _defineProperty$1({}, typeof _this15.optionGroupChildren === "string" ? _this15.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
  ...
  methods: {
    ...
    exportCSV: function exportCSV(options2, data16) {
      ...
      if (!data16) {
        ...
        else if (this.frozenValue) data16 = data16 ? [].concat(_toConsumableArray6(this.frozenValue), _toConsumableArray6(data16)) : this.frozenValue;
      }
